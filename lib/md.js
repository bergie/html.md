(function() {
  ...
  R_IGNORE_CHILDREN = /^(APPLET|AREA|AUDIO|CANVAS|DATALIST|EMBED|HEAD|INPUT|MAP|MENU|METER|NOFRAMES|NOSCRIPT|OBJECT|OPTGROUP|OPTION|PARAM|PROGRESS|RP|RT|RUBY|SCRIPT|SELECT|STYLE|TEXTAREA|TITLE|VIDEO)$/;

  R_PARAGRAPH_ONLY = /^(ADDRESS|ASIDE|DIV|FIELDSET|FOOTER|HEADER|NAV|P|SECTION)$/;
          ...
          if (R_IGNORE_CHILDREN.test(ele.tagName)) {
            ...
            switch (ele.tagName) {
              ...
              case 'A':
                ...
                suffix = this.options.inline ? "(" + href + ")" : "[" + ((_base = this.linkMap)[href] != null ? (_base = this.linkMap)[href] : _base[href] = this.links.push(href) - 1) + "]";
                this.output('[');
                this.atNoWS = true;
              ...
              case 'IFRAME':
                ...
                if (this.options.allowTags) {
                  this.p();
                  this.output(ele.outerHTML);
                  this.p();
                }
                try {
                  if ((_ref = ele.contentDocument) != null ? _ref.documentElement : void 0) {
